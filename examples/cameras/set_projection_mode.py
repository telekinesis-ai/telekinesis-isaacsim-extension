"""
PUT /cameras/{id}/projection_mode {value} -> {projection_mode}

Sets the projection mode: "perspective" or "orthographic".

Run:  python set_projection_mode.py --id camera1 --value orthographic
"""
...
def main():
    """Set one camera's projection mode and print the resulting value."""
    ...
    response = _request(
        base, "PUT", f"/cameras/{args.camera_id}/projection_mode", {"value": args.value}
    )
